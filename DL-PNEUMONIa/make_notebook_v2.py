 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Pneumonia Detection - High Accuracy Model (Transfer Learning & Hyperparameter Tuning)\n",
    "Intha notebook la ResNet50 pre-trained model, Learning Rate Scheduler, and Weight Decay use panni accuracy ah boost pannirukom."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "LEARNING_RATE = 0.0005 # Lower initial LR for Transfer Learning\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        # 1. Transfer Learning: Load Pre-trained ResNet50\n",
    "        self.resnet = models.resnet50(weights=models.ResNet50_Weights.IMAGENET1K_V1)\n",
    "        \n",
    "        # Freeze early layers so we only train the later layers (speeds up training & avoids overfitting)\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    \n",
    "    # 2. Hyperparameter Tuning: Adam Optimizer with Weight Decay\n",
    "    optimizer = optim.Adam(filter(lambda p: p.requires_grad, model.parameters()), lr=lr, weight_decay=WEIGHT_DECAY)\n",
    "    \n",
    "    # 3. Learning Rate Scheduler (Reduces LR if Validation Loss is stuck)\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    # ResNet50 target layer is typically the last convolutional block\n",
    ...
    "    axes[1].set_title('Grad-CAM Heatmap (ResNet50)')\n",
    "    axes[1].axis('off')\n",
    "    plt.show()"
   ]
  },
