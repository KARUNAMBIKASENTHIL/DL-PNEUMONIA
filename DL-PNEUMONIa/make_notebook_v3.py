 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Pneumonia Detection - High Accuracy Model (Transfer Learning)\n",
    "Intha notebook la ResNet50 pre-trained model use panni 5 epochs ku train panrom."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "BATCH_SIZE = 32\n",
    "EPOCHS = 5 # Changed back to 5 for faster training\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    \n",
    "    # Removed verbose=True to fix PyTorch Error\n",
